...
namespace End_Project.Areas.AdminArea.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> Detail(int? id)
        {
            ...
            BlogFeaturedVM blogFeatured = new BlogFeaturedVM
            {
                Id = blog.Id,
                Image= blog.Image,
                Title = blog.Title,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, BlogEditVM updateBlog)
        {
            try
            {
                ViewBag.blogCategories = await GetCategoriesAsync();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            string path = Helper.GetFilePath(_env.WebRootPath, "assets/images/blog", blog.Image);
